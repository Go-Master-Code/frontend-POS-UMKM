<script setup>
    ...
    import { generateExpenseReportPDF } from "@/api/reports";
    ...
    */
    ...
    // Generate expense report berdasarkan periode
    async function generateReport() {
        ...
        try {
            const response = await generateExpenseReportPDF({
            ...
            link.download =
                `expenses-report-${formatDate(startingDate.value)}-${formatDate(finishDate.value)}.pdf`;
            ...
            console.error("Failed to generate expenses report:", err);

            backendError.value =
                err.response?.data?.error ??
                "Failed to generate expenses report.";
    ...
    <div class="card">
        ...
        <div class="page-header">
            <div>
                ...
                <small>
                    View expenses report for a selected period.
                </small>
            </div>
        </div>
